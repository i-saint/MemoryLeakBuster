		...
		public void OnConnection(object application, ext_ConnectMode connectMode, object addInInst, ref Array custom)
		{
			...
			if(connectMode == ext_ConnectMode.ext_cm_UISetup)
			{
				...
				try
				{
					...
					Command command = commands.AddNamedCommand2(_addInInstance, "mlbVS", "mlbVS", "Executes the command for mlbVS", true, 59, ref contextGUIDS, (int)vsCommandStatus.vsCommandStatusSupported+(int)vsCommandStatus.vsCommandStatusEnabled, (int)vsCommandStyle.vsCommandStylePictAndText, vsCommandControlType.vsCommandControlTypeButton);
